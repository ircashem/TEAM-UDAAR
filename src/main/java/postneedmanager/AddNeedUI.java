 ...
 * @author ircashem
 */
public class AddNeedUI extends javax.swing.JFrame {
     ...
     */
    public AddNeedUI(DisplayManager mgr, NeedManager NM) {
        this.mgr = mgr;
        this.NM = NM;
        initComponents();
    }
...
//            jTxtCategory.setBackground(Color.white);
    ...
    private void jButtonSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSubmitActionPerformed
        ...
        nd.setAddress(jTxtAddress.getText());
        nd.setCategory(jTxtCategory.getText());
        nd.setTopWear(Integer.parseInt(jTxtTop.getText()));
        nd.setBottomWear(Integer.parseInt(jTxtBottom.getText()));
        nd.setWinterWear(Integer.parseInt(jTxtWinter.getText()));
        nd.setFootWear(Integer.parseInt(jTxtFoot.getText()));

        if (this.NM.addNeed(nd) == true){
            JOptionPane.showMessageDialog(null,"Successfully Posted Need","Success",JOptionPane.INFORMATION_MESSAGE);
