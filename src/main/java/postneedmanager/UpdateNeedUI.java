 ...
 * @author ircashem
 */
public class UpdateNeedUI extends javax.swing.JFrame {
     ...
     */
    public UpdateNeedUI(DisplayManager mgr, NeedManager NM) {
        this.NM = NM;
        this.mgr = mgr;
        initComponents();
    }
...
//        System.out.println("Heler");
        if (this.NM.updateNeed(nd) == true){
            JOptionPane.showMessageDialog(null,"Successfully Updated Your Need","Success",JOptionPane.INFORMATION_MESSAGE);
            this.mgr.showManageNeedUI();
        }
        else{
            JOptionPane.showMessageDialog(null,"Error Occurred in updating needs","Error",JOptionPane.ERROR_MESSAGE);
            this.mgr.showManageNeedUI();
        }
